...
namespace PasswordManager
{
    class Program
    {
        ...
        // Creates a client file using the master password and secret key
        static void CreateCommand(string clientPath, string serverPath)
        {
            Console.Write("Enter master password: ");
            string masterPassword = Console.ReadLine();
            ...
            try
            {
                // Decrypt the vault to verify the master password and secret key
        ...
        static void GetCommand(string clientPath, string serverPath, string prop)
        {
            ...
            // Display all properties if no specific property is requested
            if (prop == null)
            {
        ...
        // Displays the secret key from the client file
        ...
        static void ChangeCommand(string clientPath, string serverPath)
        {
            ...
            // Derive a new vault key using the new master password
        ...
        // Derives a vault key from the master password and secret key
